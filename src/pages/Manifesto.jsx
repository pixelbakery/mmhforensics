...
function Manifesto(){
    ...
    <div className="row px-5">
      <div className="col col-sm-10">
        <article>
          <h3>From Rejection to Outrage:</h3>
          <h1 className="display-1 mb-3 border-bottom-1">Convictions and Executions that Obviate <br/>the Presence of Severe Mental Illness</h1>
